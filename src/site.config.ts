...
const config: SiteConfig = {
  ...
  title: 'Hi Friend | Wxuann',
  // The description of your site, used for SEO and RSS feed.
  description:
    'A personal homepage for a person who has a mixed emotion',
  ...
  font: 'JetBrains Mono Variable, "HarmonyOS Sans SC", "Microsoft YaHei", sans-serif',
